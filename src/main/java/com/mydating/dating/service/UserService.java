...
public class UserService {
    ...
    private final DatingApplication datingApplication;
	@Autowired
	UserDao userDao;

    UserService(DatingApplication datingApplication) {
	...
	public ResponseEntity<?> findAllMaleUsers() {
		...
		if(maleUsers.isEmpty()) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No Male Users Present in the databaase table");
		}
		else {
	...
	public ResponseEntity<?> findAllFemaleUsers() {
		...
		if(femaleUsers.isEmpty()) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No Female Users Present in the databaase table");
		}
		else {
